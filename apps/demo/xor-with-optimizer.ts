/**
 * XOR example using pure functional optimizer
 */
...
console.log('🧠 XOR with Optimizer\n')
...
let optimizer = optim.adam.init(getParams(model), { lr: 0.01 })
...
const trainStep = (
  ...
  // Optimizer step
  const result = optim.adam.step(opt, getParams(m), grads)
...
// Train
console.log('Training with Adam optimizer...\n')
...
console.log('\n✨ Using Adam optimizer with pure functional API!')
